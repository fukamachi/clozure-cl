...
(defparameter *next-nx-operators*
  (reverse
   '((%primitive . 0)
     ...
     (%fixnum-ref-u32 . #.operator-single-valued-mask)
     ...
     (%fixnum-set-u32 . #.operator-single-valued-mask)
     ...
     (%set-bit   . #.(logior operator-single-valued-mask operator-acode-subforms-mask operator-side-effect-free-mask))
     (%u32+ . 0)
     (%u32- . 0)
     (%u32-logand . 0)
     (%u32-logior . 0)
     (%u32-logxor . 0)
     (%u32<> . #.(logior operator-assignment-free-mask operator-single-valued-mask operator-acode-subforms-mask operator-side-effect-free-mask operator-cc-invertable-mask))
     ...
     (%set-double-float . #.(logior operator-single-valued-mask operator-acode-subforms-mask operator-side-effect-free-mask))
      (%set-single-float . #.(logior operator-single-valued-mask operator-acode-subforms-mask operator-side-effect-free-mask))
     (u32-shift-right  . #.(logior operator-assignment-free-mask operator-single-valued-mask operator-acode-subforms-mask operator-side-effect-free-mask))
     (u32-shift-left  . #.(logior operator-assignment-free-mask operator-single-valued-mask operator-acode-subforms-mask operator-side-effect-free-mask))
     (global-ref . 0)
     (global-setq . 0)
