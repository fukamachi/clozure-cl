...
(define-ppc32-vinsn make-vcell (((dest :lisp))
  ...
  (twlt ppc::allocptr ppc::allocbase)
...
(define-ppc32-vinsn %natural+ (((dest :u64))
                               ((x :u64) (y :u64)))
  (add dest x y))

(define-ppc32-vinsn %natural+-c (((dest :u64))
                                 ((x :u64) (y :u16const)))
  (addi dest x y))
...
(define-ppc32-vinsn %natural-logior (((dest :u64))
                                     ((x :u64) (y :u64)))
  (or dest x y))

(define-ppc32-vinsn %natural-logior-c (((dest :u64))
...
(define-ppc32-vinsn %natural-logxor (((dest :u64))
                                     ((x :u64) (y :u64)))
  (xor dest x y))

(define-ppc32-vinsn %natural-logxor-c (((dest :u64))
                                       ((x :u64) (high :u16const) (low :u16const)))
  ((:not (:pred = high 0))
   (xoris dest x high))
  ((:not (:pred = low 0))
...
(define-ppc32-vinsn %natural-logand (((dest :u64))
                                     ((x :u64) (y :u64)))
  (and dest x y))

(define-ppc32-vinsn %natural-logand-high-c (((dest :u64))
                                            ((x :u64) (high :u16const))
                                            ((cr0 (:crf 0))))
  (andis. dest x high))
