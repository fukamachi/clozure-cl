...
(defparameter *x8664-opcode-templates*
  (vector
   ...
   (def-x8664-opcode cmpb ((:imm8s :insert-imm8s) (:acc :insert-nothing))
     #x3c nil nil)
   (def-x8664-opcode rcmpb ((:acc :insert-nothing) (:imm8s :insert-imm8s))
     #x3c nil nil)
   (def-x8664-opcode cmpb ((:imm8s :insert-imm8s) (:reg8 :insert-modrm-rm))
     #x80 #o370 #x00)
   (def-x8664-opcode rcmpb ((:reg8 :insert-modrm-rm) (:imm8s :insert-imm8s))
     #x80 #o370 #x00)
   (def-x8664-opcode cmpb ((:imm8s :insert-imm8s) (:anymem :insert-memory))
     #x80 #o070 #x00)
   (def-x8664-opcode rcmpb ((:anymem :insert-memory) (:imm8s :insert-imm8s))
     #x80 #o070 #x00)
