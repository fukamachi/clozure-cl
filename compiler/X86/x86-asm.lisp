...
(defparameter *x8664-opcode-templates*
  (vector
   ...
   (def-x8664-opcode cmovoq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f40 #o000 #x48)
   (def-x8664-opcode cmovol ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f40 #o300 #x00)
   (def-x8664-opcode cmovol ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f40 #o000 #x00)
   (def-x8664-opcode cmovow ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f40 #o300 #x00 #x66)
   (def-x8664-opcode cmovow ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f40 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovnoq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f41 #o000 #x48)
   (def-x8664-opcode cmovnol ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f41 #o300 #x00)
   (def-x8664-opcode cmovnol ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f41 #o000 #x00)
   (def-x8664-opcode cmovnow ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f41 #o300 #x00 #x66)
   (def-x8664-opcode cmovnow ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f41 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovbq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f42 #o000 #x48)
   (def-x8664-opcode cmovbl ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f42 #o300 #x00)
   (def-x8664-opcode cmovbl ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f42 #o000 #x00)
   (def-x8664-opcode cmovbw ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f42 #o300 #x00 #x66)
   (def-x8664-opcode cmovbw ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f42 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovaeq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f43 #o000 #x48)
   (def-x8664-opcode cmovael ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f43 #o300 #x00)
   (def-x8664-opcode cmovael ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f43 #o000 #x00)
   (def-x8664-opcode cmovaew ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f43 #o300 #x00 #x66)
   (def-x8664-opcode cmovaew ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f43 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmoveq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f44 #o000 #x48)
   (def-x8664-opcode cmovel ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f44 #o300 #x00)
   (def-x8664-opcode cmovel ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f44 #o000 #x00)
   (def-x8664-opcode cmovew ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f44 #o300 #x00 #x66)
   (def-x8664-opcode cmovew ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f44 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovneq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f45 #o000 #x48)
   (def-x8664-opcode cmovnel ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f45 #o300 #x00)
   (def-x8664-opcode cmovnel ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f45 #o000 #x00)
   (def-x8664-opcode cmovnew ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f45 #o300 #x00 #x66)
   (def-x8664-opcode cmovnew ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f45 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovbeq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f46 #o000 #x48)
   (def-x8664-opcode cmovbel ((:reg64 :insert-modrm-reg) (:reg64 :insert-modrm-reg))
     #x0f46 #o300 #x00)
   (def-x8664-opcode cmovbel ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f46 #o000 #x00)
   (def-x8664-opcode cmovbew ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f46 #o300 #x00 #x66)
   (def-x8664-opcode cmovbew ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f46 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovaq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f47 #o000 #x48)
   (def-x8664-opcode cmoval ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f47 #o300 #x00)
   (def-x8664-opcode cmoval ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f47 #o000 #x00)
   (def-x8664-opcode cmovaw ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f47 #o300 #x00 #x66)
   (def-x8664-opcode cmovaw ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f47 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovsq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f48 #o000 #x48)
   (def-x8664-opcode cmovsl ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f48 #o300 #x00)
   (def-x8664-opcode cmovsl ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f48 #o000 #x00)
   (def-x8664-opcode cmovsw ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f48 #o300 #x00 #x66)
   (def-x8664-opcode cmovsw ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f48 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovnsq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f49 #o000 #x48)
   (def-x8664-opcode cmovnsl ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f49 #o300 #x00)
   (def-x8664-opcode cmovnsl ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f49 #o000 #x00)
   (def-x8664-opcode cmovnsw ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f49 #o300 #x00 #x66)
   (def-x8664-opcode cmovnsw ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f49 #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovpeq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4a #o000 #x48)
   (def-x8664-opcode cmovpel ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4a #o300 #x00)
   (def-x8664-opcode cmovpel ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4a #o000 #x00)
   (def-x8664-opcode cmovpew ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4a #o300 #x00 #x66)
   (def-x8664-opcode cmovpew ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4a #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovpoq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4b #o000 #x48)
   (def-x8664-opcode cmovpol ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4b #o300 #x00)
   (def-x8664-opcode cmovpol ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4b #o000 #x00)
   (def-x8664-opcode cmovpow ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4b #o300 #x00 #x66)
   (def-x8664-opcode cmovpow ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4b #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovlq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4c #o000 #x48)
   (def-x8664-opcode cmovll ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4c #o300 #x00)
   (def-x8664-opcode cmovll ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4c #o000 #x00)
   (def-x8664-opcode cmovlw ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4c #o300 #x00 #x66)
   (def-x8664-opcode cmovlw ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4c #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovgeq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4d #o000 #x48)
   (def-x8664-opcode cmovgel ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4d #o300 #x00)
   (def-x8664-opcode cmovgel ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4d #o000 #x00)
   (def-x8664-opcode cmovgew ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4d #o300 #x00 #x66)
   (def-x8664-opcode cmovgew ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4d #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovleq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4e #o000 #x48)
   (def-x8664-opcode cmovlel ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4e #o300 #x00)
   (def-x8664-opcode cmovlel ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4e #o000 #x00)
   (def-x8664-opcode cmovlew ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4e #o300 #x00 #x66)
   (def-x8664-opcode cmovlew ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4e #o000 #x00 #x66)
   ...
   (def-x8664-opcode cmovgq ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4f #o000 #x48)
   (def-x8664-opcode cmovgl ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4f #o300 #x00)
   (def-x8664-opcode cmovgl ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4f #o000 #x00)
   (def-x8664-opcode cmovgw ((:reg64 :insert-modrm-rm) (:reg64 :insert-modrm-reg))
     #x0f4f #o300 #x00 #x66)
   (def-x8664-opcode cmovgw ((:anymem :insert-memory) (:reg64 :insert-modrm-reg))
     #x0f4f #o000 #x00 #x66)
