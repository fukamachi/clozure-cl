...
(defparameter *spec-class-storage-class-alist*
  `((:lisp . ,ppc32::storage-class-lisp)
    (:imm . ,ppc32::storage-class-imm)
    (:wordptr . ,ppc32::storage-class-wordptr)
    (:u8 . ,ppc32::storage-class-u8)
    (:s8 . ,ppc32::storage-class-s8)
    (:u16 . ,ppc32::storage-class-u16)
    (:s16 . ,ppc32::storage-class-s16)
    (:u32 . ,ppc32::storage-class-u32)
    (:s32 . ,ppc32::storage-class-s32)
    (:address . ,ppc32::storage-class-address)
    (:single-float . ,ppc32::storage-class-single-float)
    (:double-float . ,ppc32::storage-class-double-float)
    (:pc . ,ppc32::storage-class-pc)
    (:locative . ,ppc32::storage-class-locative)
    (:crf . ,ppc32::storage-class-crf)
    (:crbit . ,ppc32::storage-class-crbit)
    (:crfbit . ,ppc32::storage-class-crfbit)
    (t . nil)))
