...
(defstruct backend
  ...
  (lap-macros nil)
  (Xtarget-lisp-node-size 0 :type fixnum)
  (Xtarget-nil-value 0)
  (Xtarget-fixnum-shift 0)
  (Xtarget-most-positive-fixnum 0)
  (Xtarget-word-shift 0)
  (Xtarget-misc-data-offset 0)
  (Xtarget-misc-dfloat-offset 0)
  (Xtarget-nbits-in-word 0)
  (Xtarget-ntagbits 0)
  (Xtarget-nlisptagbits 0)
  (Xtarget-uvector-subtags nil)
  (target-arch nil))
