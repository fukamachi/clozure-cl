...
(macrolet ((defppcsubprim (name)
  ...
  (defparameter *subprims*
    (vector
     ...
     (defppcsubprim .SPstack_restv-arg)
     (defppcsubprim .SPreq-stack-restv-arg)
     (defppcsubprim .SPstack-cons-restv-arg)
     (defppcsubprim .SPvspreadargz)
