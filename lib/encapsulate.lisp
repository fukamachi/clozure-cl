...
one of the named functions is entered or returns.
...
The following options are defined:
   ...
   :REPORT Report-Type
       ...
       of the trace is to execute other options (e.g. PRINT or BREAK).
   ...
   :ENCAPSULATE {:DEFAULT | T | NIL}
       ...
       *not* evaluated in the function's lexical environment.
...
mocks up the lexical environment of the called function.  The -AFTER
and -ALL forms are evaluated in the null environment."
  (if syms
    `(%trace-0 ',syms)
    `(%trace-list)))
