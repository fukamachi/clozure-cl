...
_endfn
	...
	.align 12
        ...
        _spjump(stack_restv_arg)
        _spjump(req_stack_restv_arg)
        _spjump(stack_cons_restv_arg)
        _spjump(vspreadargz)
        _spjump(unbind_n)
        _spjump(unbind_to)
        _spjump(conslist)
        ...
        _spjump(makeu64)
        _spjump(makes64)
        _spjump(heap_restv_arg)
        _spjump(req_heap_restv_arg)
        _spjump(heap_cons_restv_arg)
